...
test("Card renders manually without crashing", () => {
    renderWithRouter(<Card link='.' text='ManName' icon='<icon>' />);
...
test("Card has a functional link in manual mode", () => {
    renderWithRouter(
        <Card link='dest' text='ManName' icon='<icon>' />,
...
test(
    "Card throws when text is missing",
    silentThrow(() => {
        let fn = () => {
            renderWithRouter(<Card link='dest' icon='<icon>' />);
        };
...
test(
    "Card throws when icon is missing",
    silentThrow(() => {
        let fn = () => {
            renderWithRouter(<Card link='dest' text='ManName' />);
        };
...
test(
    "Card throws when link is missing",
    silentThrow(() => {
        let fn = () => {
            renderWithRouter(<Card text='ManName' icon='<icon>' />);
        };
