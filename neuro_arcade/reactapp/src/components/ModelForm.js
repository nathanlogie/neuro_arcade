...
export function ModelForm() {
  ...
  const onSubmit = () => {
    ...
    //Will update this in a future sprint
    console.log(tags);
  ...
  return (
    <form className={'form'} onSubmit={handleSubmit(onSubmit)}>
      ...
      />
      {errors.description && <div className={'errorMessage'}>{errors.description.message}</div>}
      ...
      {errors.isAI && <div className={'errorMessage'}>{errors.isAI.message}</div>}
      ...
      {errors.root && <div className={'errorMessage'}>{errors.root.message}</div>}
    </form>
  );
}
