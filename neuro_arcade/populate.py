...
players = [
    ...
    },
    {
        ...
        "tags": [
            "High Problem Pattern Recognition Performance",
            "High Judgement Performance",
        ],
    },
    {
        "name": "Zebra Bot",
...
score_types = {
    ...
    "Flying Bird": {
        "headers": [
            {"name": "Coins", "type": "int", "min": 0, "max": 100},
            {"name": "Points", "type": "float", "min": 0},
        ]
    },
    "Suduko": {
        "headers": [
...
def add_random_score(game: Game, player_list):
    ...
    game.score_set.create(player_id=player.id, game_id=game.id, score=score)
