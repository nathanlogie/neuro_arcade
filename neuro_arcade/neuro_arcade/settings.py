...
ALLOWED_HOSTS = ["sh08.pythonanywhere.com", "127.0.0.1", "localhost"]
...
CORS_ALLOWED_ORIGIN_REGEXES = ["http://localhost:3000/*.", WEBSITE_URL + "/*"]
CORS_ALLOW_HEADERS = (*default_headers, "Authentication", "Authorisation")
